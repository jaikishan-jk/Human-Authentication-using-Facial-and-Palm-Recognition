...
def create():
    net= SiameseNetwork()
    output1=False
    net.load_state_dict(torch.load(r"C:\Users\Jaikishan\OneDrive\Desktop\Auth\facial_recognition\website\model\model.pth"))
    detector2 = HandDetector(detectionCon=0.8, maxHands=2)
    x1,exist = detector2.take_pic_to_trans()
    if exist:
